      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black flex-col justify-between p-12 xl:p-16">
        ...
        <div className="mx-auto w-full max-w-lg flex items-center justify-between">
          ...
          <div className="text-right space-y-1">
            <a href="https://chatmint.in" target="_blank" rel="noopener noreferrer" className="flex items-center justify-end gap-1.5 transition-opacity hover:opacity-80">
              <span className="text-xs text-gray-600">Product Extension of Chatmint</span>
              {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            <a href="https://xava.co.in" target="_blank" rel="noopener noreferrer" className="flex items-center justify-end gap-1.5 transition-opacity hover:opacity-80">
